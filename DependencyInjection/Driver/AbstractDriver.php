...
abstract class AbstractDriver implements DriverInterface
{
    ...
    {
        $factoryClass = $metadata->hasClass('factory') ? $metadata->getClass('factory') : 'Sylius\Component\Resource\Factory\ResourceFactory';

        $definition = new Definition($factoryClass);
        $reflection = new \ReflectionClass($factoryClass);

        $translatableFactoryInterface = 'Sylius\Component\Translation\Factory\TranslatableResourceFactoryInterface';
